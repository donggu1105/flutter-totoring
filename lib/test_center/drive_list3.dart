          ...
          ClipRRect(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(child: Text("학과시험",style: TextStyle(color: Colors.black,fontSize: 17))),
                  Tab(child: Text("기능시험",style: TextStyle(color: Colors.black,fontSize: 17))),
                  Tab(child: Text("연습면허 ",style: TextStyle(color: Colors.black,fontSize: 17))),
                  Tab(child: Text("도로주행시험",style: TextStyle(color: Colors.black,fontSize: 17))),
                  Tab(child: Text("운전면허증발급",style: TextStyle(color: Colors.black,fontSize: 17))),
                ],
              ),
            ),
          ),
            ...
            child: SizedBox(
              child: TabBarView(
                ...
                children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: const [
                                    Text('1종대형,대형견인,소형견인,구난차(19세 이상 1,2종보통 면허 취득후 1년 경과한 자)'),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('응시원서(신체검사 완료 또는 건강검진결과서 조회·제출),'),
                                    Text('신청일로부터 6개월 내에 모자를 벗은 상태에서 배경 없이 촬영된 3.5X4.5cm 규격의 상반신 컬러사진 (허용되는 사진규격) 3매,'),
                                    Text('신분증 (신분증 인정 범위)'),
                                  ],
                                ),
                              ),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('안전운전에 필요한 교통법규 등 공개된 학과시험 문제은행 중 40문제 출제'),
                                  ],
                                ),
                              ),
                            ],
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: const [
                                    ...
                                    Text('합격 또는 불합격도장이 찍힌 응시원서를 돌려 받아 본인이 보관'),
                                  ],
                                ),
                              ),
                            ],
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('1년경과 시 기존 원서 폐기 후 학과 시험부터 신규 접수하여야 하며 이때 교통안전교육 재수강은 불필요'),
                                  ],
                                ),
                              ),
                            ],
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('시험문제와 보기를 음성으로 들을 수 있는 PC학과시험 시험시간 총 80분,'),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text('청각장애인이면서 비문해자를 위한 수화로 보는 PC학과시험 시험시간 총 80분,민원실에서 접수 시 신청 가능'),
                  ...
                  SingleChildScrollView( //기능시험 1종대형
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          OutlinedButton(
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=> Daehyeong()));
                              },
                              child: Text('1종대형 시험코스 및 채점기준  바로보기 →')),
                          const SizedBox(height: 7),
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('온라인 접수 또는 현장 예약접수 후 시험 당일 응시원서, 신분증 지참'),
                                  ],
                                ),
                              ),
                            ],
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('출발 > 횡단보도 > 경사로 > 굴절 > 교차로 > 곡선 > 교차로 > 방향전환> 교차로 > 철길 > 기어변속구간 > 평행주차 > 교차로 > 종료'),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('특별한 사유 없이 출발선에서 30초 이내 출발 하지 못한 때'),
                                    Text('경사로코스·굴절코스·방향전환코스·기어 변속코스(자동변속기장치 자동차의 경우는 제외) 및 평행주차코스를 어느 하나라도 이행하지 아니한 때'),
                                    Text('특별한 사유 없이 교차로 내에서 30초 이상 정차한 때'),
                                    Text('안전사고를 일으키거나 단 1회라도 차로를 벗어난 때'),
                                    Text('경사로 정지 구간 이행 후 30초를 초과하여 통과하지 못한 때 또는 경사로 정지 구간에서 후진하여 앞 범퍼가 경사로 사면을 벗어난 때'),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('기능시험 불합격자는(운전전문학원 검정 불합격 포함) 불합격 일로부터 3일 경과 후에 재 응시 가능'),
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  OutlinedButton(
                                      onPressed: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=> Daehyeonggyeonincha()));
                                      },
                                      child: Text('대형견인(츄레라) 시험코스 및 채점기준  바로보기')),
                                  OutlinedButton(
                                      onPressed: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=> Sohyeonggyeonincha()));
                                      },
                                      child: Text('소형견인(캠핑카) 시험코스 및 채점기준  바로보기')),
                                  OutlinedButton(
                                      onPressed: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=> Gunancha()));
                                      },
                                      child: Text('구난차(렉카) 시험코스 및 채점기준  바로보기')),
                                ],
                              ),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text('기능시험 불합격자는(운전전문학원 불합격 포함) 불합격 일로부터 3일 경과 후에 재 응시 가능'),
                                        Text('예) 1일(월요일)에 불합격하였을 경우, 4일(목요일)부터 재 응시 가능'),
                                      ],
                                    ),
                                  ),
                          ...
                          Column( //1,2종보통
                            children: [
                              ...
                              OutlinedButton(
                                  ...
                                  child: Text('1.2종보통 시험코스 및 채점기준  바로보기')),
                              const SizedBox(width: 7),
                              Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text('주행거리 300m 이상, 운전장치 조작, 차로 준수·급정지, 경사로, 좌·우회전, 직각 주차, 신호교차로, 전진(가속구간)'),
                                      ],
                                    ),
                                  ),
                                ],
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('시험 중 안전사고를 일으키거나 차의 바퀴 어느 하나라도 연석을 접촉한 때'),
                                        Text('시험관의 지시나 통제를 따르지 않거나 음주, 과로, 마약·대마 등 약물 등 의 영향으로 정상적인 시험 진행이 어려운 때'),
                                        Text('특별한 사유 없이 출발 지시 후 출발선에서 30초 이내 출발하지 못한 때'),
                                        Text('각 시험 코스를 어느 하나라도 시도하지 않거나 제대로 이행하지 않을 때'),
                                        Text('(예: 경사로에서 정지하지 않고 통과, 직각 주차에서 차고에 진입해서 확인선을 접촉하지 않음,가속코스에서 기어변속을 하지 않음)'),
                                        Text('경사로 정지 구간 이행 후 30초를 초과하여 통과하지 못한 때 또는 경사로 정지구간에서 후방으로 1미터 이상 밀린 때'),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: const [
                                        Text('학과시험 합격일로부터 1년 이내 기능시험에 합격하여야 함.'),
                                        Text('1년경과 시 기존 원서 폐기 후 학과시험부터 신규 접수하여야 하며 이때 응시 전 교통안전교육 재수강은 불필요'),
                                      ],
                                    ),
                                  ),
                                ],
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text('기능시험 불합격자는(운전전문학원 불합격 포함) 불합격 일로부터 3일경과 후에 재 응시 가능'),
                                        Text('예) 1일(월요일)에 불합격하였을 경우, 4일 (목요일)부터 재 응시 가능'),
                                      ],
                                    ),
                                  ),
                          ...
                          Column( //2종소형면허
                            children: [
                              ...
                              OutlinedButton(
                                  ...
                                  child: Text('2종소형(원동기) 시험코스 및 채점기준  바로보기')),
                              const SizedBox(height: 7),
                              Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text('온라인 접수 또는 현장 예약 접수 후 시험당일 응시원서, 신분증 지참'),
                                      ],
                                    ),
                                  ),
                                ],
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        const Text('기능시험 불합격자는(운전전문학원 불합격 포함) 불합격 일로부터 3일경과 후에 재 응시 가능'),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: const [
                                  Text('연습면허의 유효기간은 1년'),
                                  Text('최초 1종 연습면허 소지자가 2종 보통 연습 면허로 격하하여 교환 발급 시 최초 발급받은 연습면허 잔여기간을 유효기간으로 하는 연습 면허가 발급됨'),
                                ],
                              ),
                            ),
                          ],
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('긴급자동차 양보, 어린이보호구역, 지정 속도 위반 등 안전운전에 필요한 57개 항목을 평가'),
                                  ],
                                ),
                              ),
                            ],
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('3회 이상 "출발 불능", "클러치 조작 불량으로 인한 엔진 정지", "급브레이크 사용","급조작·급출발" 또는 그 밖의 사유로 운전능력이 현저하게 부족한 것으로 인정할 수 있는 행위를 한 경우'),
                                    Text('안전거리 미확보나 경사로에서 뒤로 1미터 이상 밀리는 현상 등 운전능력 부족으로 교통사고를 일으킬 위험이 현저한 경우 또는 교통사고를 야기한 경우'),
                                    Text('음주, 과로, 마약, 대마 등 약물의 영향 이나 휴대전화 사용 등으로 정상적으로 운전하지 못할 우려가 있거나 교통안전과 소통을 위한 시험관의 지시 및 통제에 불응한 경우'),
                                    Text('신호 또는 지시에 따르지 않은 경우'),
                                    Text('보행자 보호의무 등을 소홀히 한 경우'),
                                    Text('어린이 보호구역, 노인 및 장애인 보호구역에 지정되어 있는 최고 속도를 초과한 경우'),
                                    Text('도로의 중앙으로부터 우측 부분을 통행하여야 할 의무를 위반한 경우'),
                                    Text('법령 또는 안전표지 등으로 지정되어 있는 최고 속도를 시속 10킬로미터 초과한 경우'),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('연습운전면허 유효기간(발급일로부터 1년) 이내 도로주행시험에 합격하여야 함.'),
                                    Text('연습운전면허 유효기간이 지났을 경우, 도로주행시험 접수가 불가능하며 학과시험, 기능 시험에 재응시하여야 함. (응시 전 교통안전교육은 재수강 불필요)'),
                                  ],
                                ),
                              ),
                            ],
                              ...
                              children: [
                                ...
                                Row(
                                  children: [SizedBox(width: 10,),
                                    Expanded(
                                        child: Text('※ 각 응시 종별(1종 대형, 1종 보통, 1종 특수, 2종 보통, 2종 소형, 2종원동기장치 자전거)에 따른 응시과목을 최종 합격했을 경우 발급')),
                                  ],
                                ),
                                SizedBox(height: 7,),
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: const [
                                          Text('1,2종 보통 면허 : 연습면허 발급 후 도로주행시험 (운전전문학원 졸업자는 도로주행 검정)에 합격한 자'),
                                          Text('기타 면허 : 학과시험 및 장내기능 시험에 합격한 자'),
                                        ],
                                      ),
                                    ),
                                  ],
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          const Text('최종 합격한 응시원서, 신분증, 최근 6개월 이내 촬영한 컬러 사진 (규격 3.5cm*4.5cm) 1매, '),
                                          const Text('수수료 : 운전면허증(국문,영문) 10,000원, 모바일 운전면허증(국문,영문) 15,000원'),
