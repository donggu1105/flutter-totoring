...
class Drive_list extends StatelessWidget {
  const Drive_list({Key? key}) : super(key: key);
                   ...
                   Align(
                     ...
                     child: Column(
                       ...
                       children: [
                         ...
                         const Text('(문경,강릉,태백,광양,충주,춘천시험장 내 신체검사원 없음)',style: TextStyle(color: Colors.black,fontSize: 15)),
                         const SizedBox(height: 7),
                   ...
                   Align(
                     ...
                     child: Column(
                       ...
                       children: [
                         ...
                         const Text('6개월 이내 촬영한 컬러 사진(3.5*4.5cm) 3매 ',style: TextStyle(color: Colors.black,fontSize: 15)),
                         const SizedBox(height: 7),
                   ...
                   Align(
                     ...
                     child: Column(
                       ...
                       children: [
                         ...
                         const Text('제 1,2종 보통면허시험 응시자로 학과시험,',style: TextStyle(color: Colors.black,fontSize: 15)),
                         const Text('장내기능 시험에 모두 합격한자 ',style: TextStyle(color: Colors.black,fontSize: 15)),
                         const SizedBox(height: 7),
                         ElevatedButton(onPressed: (){
                   ...
                   Align(
                     ...
                     child: Column(
                       ...
                       children:  [
                         ...
                         const Text('제1,2종 보통면허: 연습면허 취득 후 도로주행시험에 합격한자',style: TextStyle(color: Colors.black,fontSize: 15)),
                         const Text('기타 면허:학과시험 기능시험에 합격한 자',style: TextStyle(color: Colors.black,fontSize: 15)),
                         const SizedBox(height: 7),
                         ElevatedButton(onPressed: (){
                           launch('https://www.safedriving.or.kr/mainM.do');
                         },
