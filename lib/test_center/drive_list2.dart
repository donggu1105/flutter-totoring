          ...
          ClipRRect(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: const [
                  Tab(child: Text("응시 전 교통안전교육",style: TextStyle(color: Colors.black,fontSize: 17))),
                  Tab(child: Text("신 체 검 사",style: TextStyle(color: Colors.black,fontSize: 17))),
                ],
              ),
            ),
          ),
            ...
            child: SizedBox(
              child: TabBarView(
                ...
                children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: const [
                                    ...
                                    Text('군 운전면허소지자 중 일반 운전면허로 갱신 하는 자'),
                                    Text('※ 교육대상자 제외'),
                                    Text('운전면허가 있는 사람이 다른 종류의 운전면허를 취득하고자 하는 자 (원동기장치자전거 면허 소지자 포함)'),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('교육 수강 신청 및 접수 > 지문등록 > 수강카드발급 > 강의실 입실 > 교육수강'),
                                  ],
                                ),
                              ),
                            ],
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children:  [
                                    const Text('신규면허 발급 전까지 유효기간 이내에는 수회에 걸쳐 면허시험에 응시 하더라도 추가 교육 수강 의무 면제'),
                  ...
                  SingleChildScrollView(
                    child: Container(alignment: Alignment.topLeft, //신체검사
                      child: Column(
                        children: [
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('운전면허시험장 내 신체검사실 또는 병원(문경, 강릉, 태백, 광양, 충주, 춘천시험장은 신체검사실이 없으므로 병원에서 받아와야 함)'),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: const [
                                  Text('준비물 및 주의사항 ',style: TextStyle(fontWeight: FontWeight.bold)),
                                ],
                              ),
                              const SizedBox(width: 7),
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('신분증, 6개월 이내 촬영한 컬러 사진 (규격 3.5cm*4.5cm) 2매'),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          Row(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: const [
                                    Text('시험장 내 신체검사실: 1종 대형/특수면허 7,000원, 기타 면허 6,000원'),
                                    Text('건강검진결과내역서 등 제출 시 신체검사비 무료(1종보통, 7년 무사고만 해당)'),
                                    Text('시험장 내 신체검사장 외의 병원인 경우 신체검사비는 일반의료수가에 따름'),
                                    Text('국민건강보험법 또는 의료급여법에 따른 건강검진 결과 또는 병역법에 따른 병역판정 신체검사 결과(신청일로부터 2년 이내)를 받으신 경우는 운전면허시험장 또는 경찰서에서 본인이 정보이용동의서 작성 시 별도의 건강검진결과 내역서 제출 및 신체검사를 받지 않아도 됨 (단, 신청일로부터 2년 이내여야 하며, 시력 또는 청력기준을 충족해야 함)'),
                                  ],
                                ),
                              ),
                            ],
