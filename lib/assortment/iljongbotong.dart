                              ...
                              Column(
                                ...
                                children: [
                                  const SizedBox(
                                    child: SizedBox(
                                      width: 465,
                                      child: Image(image: AssetImage('image/1b2b.png')),
                                    ),
                                  ),
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: const [
                                          ...
                                          Text(' 2. 경사로코스, 방향전환코스, 기어변속구간을 어느 하나라도 이행하지'),
                                          Text('    아니한 때'),
                                          Text(' 3. 특별한 사요없이 교차로를 30초 이내 통과하지 못한때'),
                                          Text(' 4. 시험중 안전사고를 일으키거나 단1회라도 차로를 벗어 났을때'),
                                          Text(' 5. 경사로 정지구간 이행후 30초를 초과하여 경사구간을 통과하지 못한때'),
                                          Text('    또는 경사 정지구간에서 후진하여 앞 범퍼가 경사로 사면을 벗어난 때'),
                              ...
                              Column(
                                ...
                                children: [
                                  SizedBox(
                                    child: SizedBox(
                                      width: 465,
                                      child: Image(image: AssetImage('image/doro1.png')),
                                    ),
                                  ),
                                  SizedBox(
                                    child: SizedBox(
                                      width: 465,
                                      child: Image(image: AssetImage('image/doro2.png')),
                                    ),
                                  ),
                                  SizedBox(
                                    child: SizedBox(
                                      width: 465,
                                      child: Image(image: AssetImage('image/doro3.png')),
                                    ),
                                  ),
                                  SizedBox(
                                    child: SizedBox(
                                      width: 465,
                                      child: Image(image: AssetImage('image/doro4.png')),
                                    ),
                                  ),
                                  SizedBox(height: 15),
                                  Row(
                                    children: [
                                      Column(
                                        ...
                                        children: const [
                                          ...
                                          Text(' 운전자세, 제동장치 및 조향장치 조작, 직진 및 좌.우회전, 진로변경 등'),
                                          Text(' 총 87개 채점 항목'),
                                          SizedBox(height: 7),
                                          ...
                                          Text(' - 70점 이상 합격'),
                                          Text(' - 시험관이 채점표에 의하여 감점방식으로 채점'),
                                          Text('  ( 2012년 11월 1일 도로주행시험 노선 및 채점에 전자채점시스템 도입)'),
                                          SizedBox(height: 7),
                                          Text('실격기준',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,color: Colors.red)),
                                          Text(' - 3회 이상 출발블능 또는 응시자가 시험을 포기한 경우'),
                                          Text(' - 5회 이상 "클러치 조작 불량으로 인한 엔진정지", "급브레이크 사용"'),
                                          Text(' 또는 그 밖의 사유로 운전능력이 현저하게 부족한 것으로 인정되는 경우'),
                                          Text(' - 교통사고 야기한 경우 또는 운전능력부족으로 일으킬 위험이 현저한 경우'),
                                          Text(' - 교통사고 예방 및 시험 진행을 위한 시험관 지시.통제에 불응한 경우'),
                                          Text(' - 보행자 보호의무 위반, 신호 또는 지시위반, 중앙선 침범, 어린이 통학'),
                                          Text(' 버스 보호의무 위반한 경우'),
                                          SizedBox(height: 7),
                                          Text(' 기타',style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold)),
                                          Text(' - 연습면허 유효기간 내에 도로주행시험에 합격해야 합니다.'),
                                          Text(' - (유효기간이 지났을 경우에는 다시 PC학과시험, 장내기능시험에 합격 후에'),
                                          Text(' - 연습면허 발급 받아야 함)'),
