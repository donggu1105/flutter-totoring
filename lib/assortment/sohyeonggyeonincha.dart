                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      child: SizedBox(
                                        width: 400,
                                        child: Image(image: AssetImage('image/sohyeonggyeonincha1.png')),
                                      ),
                                    ),
                                    SizedBox(height: 15),
                                    Row(
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: const [
                                              ...
                                              Text('소형 견인 트레일러 면허시험은 1톤 화물트럭에 평판형 트레일러를 연결해 치르게 되며, 시험코스는 굴절.곡선 방향전환등 3개 코스로 이루어져 있습니다.'),
                                              SizedBox(height: 3),
                                              Text('굴절코스 : 지정시간 3분 초과시 마다 또는 검지선 접촉 시 마다 10점 감점'),
                                              Text('곡선코스 : 지정시간 3분 초과시 마다 또는 검지선 접촉 시 마다 10점 감점'),
                                              Text('방향전환코스 : 확인선을 미접촉하거나 지정시간 3분 초과시마다 또는 검지선 접촉시마다 10점 감점'),
                                              SizedBox(height: 7),
