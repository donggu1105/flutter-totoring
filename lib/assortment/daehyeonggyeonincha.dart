                              ...
                              Column(
                                ...
                                children: [
                                  SizedBox(
                                    child: SizedBox(
                                      width: 490,
                                      child: Image(image: AssetImage('image/daehyeonggyeoninchacos.png')),
                                    ),
                                  ),
                                  SizedBox(
                                    child: SizedBox(
                                      width: 490,
                                      child: Image(image: AssetImage('image/daehyeonggyeonincha.png')),
                                    ),
                                  ),
                                  SizedBox(height: 15),
                                  Row(
                                    children: [
                                      Column(
                                        ...
                                        children: const [
                                          ...
                                          Text('- 면허취소자 - 신분증,운전경력증명서,응시원서(운전면허신체검사)'),
                                          Text('  사진= 3x4 반명함 3장'),
                                          Text('- 운전면허증 또는 신분증'),
                                          Text('- 응시료 : 25,000'),
                                          ...
                                          Text('2) A지점의 확인선을 접촉하고, 후진으로 B지점의 확인선을 접촉 한후'),
                                          Text('   다시 A지점으로 전진하였다가 후진으로 출발지점에 도착 한다.'),
                                          Text('3) 출발지점에 도착한 후 피견인차를 5분 이내에 분리한다.'),
                                          Text('   총 지정시간은 15분이내이다'),
                                          SizedBox(height: 7),
