...
class Daehyeong extends StatefulWidget {
  Daehyeong({Key? key}) : super(key: key);
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SizedBox(
                                      child: SizedBox(
                                        width: 400,
                                        child: Image(image: AssetImage('image/daehyeongcos1.png')),
                                      ),
                                    ),
                                    SizedBox(height: 15,),
                                    SizedBox(
                                      child: SizedBox(
                                        width: 400,
                                        child: Image(image: AssetImage('image/daehyong1.png')),
                                      ),
                                    ),
                                    SizedBox(height: 15),
                                    Row(
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text('면허취소자 - 운전면허증(신분증),운전경력 증명서,응시원서(운전면허신체검사) 사진= 3x4 반명함 3장'),
                                              Text('운전면허증 또는 신분증'),
                                              Text('응시료 : 25,000'),
                                              ...
                                              Text('좌측방향지시등을 켜고 출발 한다. 삐소리가 나면 바로 방향지시등을 끈다. 횡단보도 일시정지 후 약 3초 후에 출발한다. '
                                                  ...
                                                  '비상등을 켜세요. 그리고 돌발 상황이 지나면 비상을을 끄고 출발 약 3초 후 출발 하세요.바로 출발하면 감점될수 있습니다.'),
                                              SizedBox(height: 3),
                                              Text('굴절코스 : 지정시간 2분 초과시 마다 또는 검지선 접촉 시 마다 5점 감점'),
                                              Text('곡선코스 : 지정시간 2분 초과시 마다 또는 검지선 접촉 시 마다 5점 감점'),
                                              Text('방향전환코스 : 확인선을 미접촉하거나 지정시간 2분 초과 시 마다 또는 검지선 접촉시마다 5점 감점'),
                                              Text('주차코스 : 확인선을 미접촉하거나 지정시간 2분 초과 시 마다 또는 검지선 접촉시마다 5점 감점, 주차 확인선 미접촉시 10점 감점(앞.뒷바퀴가 흰색 주차선 미접촉시)'),
                                              SizedBox(height: 7),

                                              Text('합격기준',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17)),
                                              Text('각 시험 항목별 감점기준에 따라 감점한 결과 100점 만점에 80점이상을 얻은 때'),
                                              SizedBox(height: 7),

                                              Text('실격기준',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,color: Colors.red)),
                                              Text('1) 특별한 사유없이 출발선에서 30초 이내 출발하지 못한 때'),
                                              Text('2) 경사로코스,굴절코스,곡선코스,방향전환코스, 기어변속코스 및 평행주차 코스를 어느 하나라도 이행하지 아니한 때'),
                                              Text('3) 특별한 사유없이 교차로를 30초 이내에 통과하지 아니한 때'),
                                              Text('4) 시험중 안전사고를 일으키거나 단 1회라도 차로를 벗어날 때'),
                                              Text('5) 경사로 정지구간 이행 후 30초를 초과하여 경사구간을 통과하지 못한 때 또는 경사정지구간에서 후진하여 앞 범퍼가 경사로 사면을 벗어난 때'),
                                                ...
                                                child: Row(
                                                  children: [
                                                    ElevatedButton(
                                                        ...
                                                        child: Text('시험접수 GO',style: TextStyle(color: Colors.black),)),
                                                  ],
                                                ),
                                              ),
                                            ],
