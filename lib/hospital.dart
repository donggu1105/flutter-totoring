...
class HosPital extends StatefulWidget {
  ...
  @override
  State<HosPital> createState() => _Screen2State();
}

class _Screen2State extends State<HosPital> with TickerProviderStateMixin {
          ...
          Card(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: const [
                  Tab(child: Text("+ 신체검사지정병원",style: TextStyle(fontWeight: FontWeight.w800,color: Colors.white))),
                ],
              ),
            ),
          ),
