...
class Korea3 extends StatefulWidget {
  Korea3({Key? key}) : super(key: key);

  @override
  State<Korea3> createState() => _Screen2State();
}

class _Screen2State extends State<Korea3> with TickerProviderStateMixin {
          ...
          Container(
            child: Container(
              child: Builder(
                  builder: (context) {
                    return Container(
                      child: Text('1종대형',style: TextStyle(
