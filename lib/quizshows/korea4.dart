...
class Korea4 extends StatefulWidget {
  Korea4({Key? key}) : super(key: key);

  @override
  State<Korea4> createState() => _Screen2State();
}

class _Screen2State extends State<Korea4> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('2종소형(원동기) 40문항',style: TextStyle(color: Colors.white),),
      ),
      body: Column(
        children: [
          ...
          Expanded(
            child: SizedBox(
              child: TabBarView(
                ...
                children: [
                  Obx(()=> GestureDetector( //2종소형(원동기) 40문항
                    child: Container(
                        ...
                        title: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              Get.arguments[0][problemNum.value]['image'] == null ? Container(): Image.network(Get.arguments[0][problemNum.value]['image']), //이미지 있으면 가져오고 없으면 x
