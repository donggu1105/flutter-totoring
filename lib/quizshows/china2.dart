                            ...
                            children: [
                              ...
                              Row( //문제
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 3,),
                                  Expanded(
                                      child: Text(Get.arguments[0][problemNum.value]['question'].toString()+'(${(Get.arguments[0][problemNum.value]['score'].toString())}점 문제)',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold))),
                                ],
                              ),
