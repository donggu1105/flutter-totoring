...
class English2 extends StatefulWidget {
  ...
  @override
  State<English2> createState() => _Screen2State();
}

class _Screen2State extends State<English2> with TickerProviderStateMixin {
              ...
              children: [
                ...
                ElevatedButton(onPressed: () {
                  if (selectedNumList['${problemNum.value + 1}번문제'] != null) {
                    ...
                    problemNum.value == null ? print('마지막 문제 입니다') : problemNum.value++;
