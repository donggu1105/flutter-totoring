...
class Vietnam3 extends StatefulWidget {
  Vietnam3({Key? key}) : super(key: key);

  @override
  State<Vietnam3> createState() => _Screen2State();
}

class _Screen2State extends State<Vietnam3> with TickerProviderStateMixin {
