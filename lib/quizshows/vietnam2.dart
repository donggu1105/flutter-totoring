...
class Vietnam2 extends StatefulWidget {
  const Vietnam2({Key? key}) : super(key: key);

  @override
  State<Vietnam2> createState() => _Screen2State();
}

class _Screen2State extends State<Vietnam2> with TickerProviderStateMixin {
          ...
          Container(
            child: Container(
              child: Builder(
                  builder: (context) {
                    return Container(
                      child: Text('2종소형(원동기)',style: TextStyle(
                        ...
                        title: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              //problemNum.value == 29 ?YoutubePlayer(controller: youtubePlayerController , aspectRatio: 16/9,): Container(),
