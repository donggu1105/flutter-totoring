...
class Korea2 extends StatefulWidget {
  Korea2({Key? key}) : super(key: key);

  @override
  State<Korea2> createState() => _Screen2State();
}

class _Screen2State extends State<Korea2> with TickerProviderStateMixin {
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: Text(
                                            Get.arguments[0][problemNum.value]
                                            ['question']
                                                .toString() +
                                                '(${(Get.arguments[0][problemNum.value]['score'].toString())}점 문제)',
                                            style: TextStyle(
                                                fontSize: 20,
                                ...
                                Get.arguments[0][problemNum.value]['image'] ==
                                    null
                                    ? Container()
                                    : Image.network(Get.arguments[0]
                                [problemNum.value]['image']),
                                ...
                                Text(Get.arguments[0][problemNum.value]
                                ['answer']
                                    .toString()),
                                Text(Get.arguments[0][problemNum.value]['score']
                                    .toString()),
                              ],
                            ),
                          ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (selectedNumList['${problemNum.value + 1}번문제'] != null) {
                      ...
                      if (selectedNumList['${problemNum.value + 2}번문제'] !=
                          null) {
                        selectedNum.value =
                      ...
                      ['answer']
                          .toString(); // 정답
                      if (correctAnswers
                          .contains(selectedNum.value.toString())) {
                        // 정답일경우
                        ...
                        confirm: ElevatedButton(
                            onPressed: () {
                              if (score > 60) {
                                ...
                                problemNum.value++;
                                selectedNum.value = selectedNumList
                                    .containsKey(problemNum.value + 1)
